package com.obs.excel.services.impl;
...
@Service
public class OrdersExcelImportServiceImpl implements OrdersExcelImportService { 
	
	@Autowired
	private UpsServiceImpl upsServiceImpl;
	
	public OrdersExcelImportServiceImpl(UpsServiceImpl upsServiceImpl) {
	 ...
	 try
     {
         ...
         while (rowIterator.hasNext()) 
         {
             ...
             UpsOrder upsOrder = new UpsOrder();
            	 ...
            	 upsServiceImpl.upsUpSetProductName(upsOrder);
            	 upsServiceImpl.upsSetService(upsOrder);
